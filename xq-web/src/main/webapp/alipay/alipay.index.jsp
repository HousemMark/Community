...
<body text=#000000 bgColor="#ffffff" leftMargin=0 topMargin=4>
	...
	<div id="main">
		...
		<form name=alipayment action=goPay.do method=post target="blank">
			<div id="body1" class="show" name="divcontent">
				<dl class="content">
					<dt>流水单号 ：</dt>
					<dd>
						<input id="flow_id" name="flow_id"/>
					</dd>
					<hr class="one_line">
					<dt>缴费订单号 ：</dt>
					<dd>
						<input id="fee_id" name="fee_id"/>
					</dd>
					<hr class="one_line">
					<dt>订单名称 ：</dt>
					<dd>
...
<script language="javascript">
	...
	function GetDateNow() {
		...
		var type = data.type;
		var sum = data.sum
		document.getElementById("flow_id").value = sNow;
		document.getElementById("fee_id").value = id;
		document.getElementById("fee_type").value = type;
		document.getElementById("fee_sum").value = sum;
	}
	GetDateNow();
</script>
</html>